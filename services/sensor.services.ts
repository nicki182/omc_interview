...
class SensorServices implements CRUDService<SensorDTO, SensorWithTemperaturesAndMalfunctions> {
    ...
    public async create(data: Sensor): Promise<SensorDTO> {
        ...
        await this.redis.set(`${this.cacheKey}${sensor.id}`, JSON.stringify(sensor));
